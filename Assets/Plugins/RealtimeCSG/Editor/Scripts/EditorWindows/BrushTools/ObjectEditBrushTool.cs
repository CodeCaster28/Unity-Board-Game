...
namespace RealtimeCSG
{
	internal sealed class ObjectEditBrushTool : ScriptableObject, IBrushTool
	{
		...
		public void FlipX() { ControlMeshUtility.FlipX(brushes); UpdateTargetInfo(); }
		public void FlipY() { ControlMeshUtility.FlipY(brushes); UpdateTargetInfo(); }
		public void FlipZ() { ControlMeshUtility.FlipZ(brushes); UpdateTargetInfo(); }
